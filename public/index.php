...
<body class="bg-white font-body font-normal">
    <div class="mx-36">
           ...
           <?php include("navbar.php") ?>
            <div class="flex items-center">
                <div class="w-1/2">
                    ...
                    <div class="text-sm">
                        <p class="pb-4 text-gray-400">My name is Adams David and I am a Product Designer.</p>
                        <div class="pb-4 mb-8 text-brand-gray-dark">
                        ...
                        <div class="">
                            <button class="bg-brand-yellow-light rounded-full px-7 py-2 text-white">Get in touch</button>
                            <button class="bg-transparent text-brand-gray-dark font-bold rounded-full px-7 py-2">Download resume</button>
                        </div>
                    </div>
                </div>
        ...
        <main>
            <section class="">
                <div class="py-16">
                    <h2 class="text-center text-brand-gray-dark mb-1">projects</h2>
                    <div class="w-20 m-auto border-t-2 border-brand-yellow-light mb-5"></div>
                    <p class="text-center text-sm font-normal text-gray-400">Here are some projects I had worked on for some clients</p>
                </div>
                <div class="flex mb-12">
                    ...
                    <div class="w-1/2 bg-brand-blue-dark">
                        <div class="py-16 m-auto text-white w-3/4">
                            ...
                            <button class="rounded-full bg-brand-yellow-light px-12 py-3">View case study</button>
                        </div>
                    </div>
                </div>
                <div class="flex mb-12">
                ...
                <div class="flex justify-center ">
                    <button class="mb-12 border-2 border-brand-yellow-light rounded-full py-2 px-10 text-brand-gray-dark font-bold">more projects</button>
                </div>
            </section>
        </main>
