        ...
        <main class="max-w-6xl px-5 mx-auto md:px-0">
                    ...
                    <div class="mt-10 text-justify md:w-3/4 md:mt-0">
                        ...
                        <div class="text-sm leading-loose">
                            <p class="mt-8">Trying to search for a particular style or design over here in our community has left our culture in regards to online vendors 
                                (e-commerce mainstream) where you can buy anything you want but then the essence to taste in fashion is based on the idea to a particular type of style. <br>
                                The information as to fashion hub website in our community does not work, hence online vendors which only showcase different style/trend
                                without proper catalogue of a particular brand/fashion style which can be difficult to navigate; as such, I took this personal project
                                as my first step into UI Design. 
                            </p>
                            <p class="mt-8">Although, it is a one page design and showcase a landing page feature of what the website does before you get the actual content
                                which as a user must be signed in to access other features or products the website has to offer.
                            </p>
                            <p class="mt-8">So, the idea behind the design was to conceptualized a website that has a fashion catalogue and also accomodate e-commerce features to enhance seamless userbility.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="mx-auto my-16 md:w-2/3">
                            ...
                            <div>
                                <table class="text-sm table-fixed">
                                    <thead class="text-left text-white bg-black">
                                        <tr class="">
                                            <th class="w-2/12 p-3">As a</th>
                                            <th class="w-5/12 p-3">I want to</th>
                                            <th class="w-5/12 p-3">so that</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-black bg-gray-300 border">
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to have an idea of the website at glance</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">I can have a faster access and response</td>
                                        </tr>
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to view different catalogues when signed In</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">I can have an idea of new trends and cost of item</td>
                                        </tr>
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to view images and description</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">I can add them to my wishlist</td>
                                        </tr>
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to view products</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">I can select the item trendy for me</td>
                                        </tr>
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to view promo sales cost price</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">I can add to wishlist or purchase item</td>
                                        </tr>
                                        <tr>
                                            <td class="w-2/12 p-3 border-2 border-gray-500">customer</td>
                                            <td class="w-5/12 p-3 border-2 border-gray-500">be able to view images and description</td>
                ...
                <div class="my-16 md:my-24">
                    ...
                    <div class="my-12 md:my-6">
                        ...
                        <div class="flex justify-between w-full px-3 py-5 my-0 space-x-6 text-xs text-gray-400 bg-black bg-opacity-25 rounded md:py-10 md:px-6 md:my-14 md:space-x-14">
                            ...
                            <div class="w-5/12">
                                <div>Text Logo</div>
                                <p class="mt-12 mb-6">You need to Signup to access the full content of the page, view account(signed in), and other item added to cart, see wishlist on catalogues saved</p>
                    ...
                    <div class="flex items-center justify-center space-x-3">
                        <button class="px-6 py-2 bg-brand-gray-light">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.828 6.99968H16V8.99968H3.828L9.192 14.3637L7.778 15.7777L0 7.99968L7.778 0.22168L9.192 1.63568L3.828 6.99968Z" fill="white" fill-opacity="0.85"/>
                            </svg>
                        </button>
                        <button class="px-6 py-2 bg-brand-gray-light">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.172 6.778L6.808 1.414L8.222 0L16 7.778L8.222 15.556L6.808 14.142L12.172 8.778H0V6.778H12.172Z" fill="white" fill-opacity="0.25"/>
                            </svg>
                        </button>
                    </div>
                </div>
            ...
            <section>
                <div class="relative my-24">
                    <div class="text-lg font-bold">Hi-Fidelity Mockups</div>
                    <p class="mt-5 mb-10 text-sm text-justify">
                        For the look and feel I wanted the website to mirror the look and feel of an e-commerce but maintian the fashion catalogue outlook which is predominantly
                        white in colour. For this project, I made it a personal thing as it was my journey into the world of design for the first time.
                    </p>
                    <div class="flex items-center w-full">
                        <div class="z-20 w-1/3 mr-8">
                            <img src="img/shoplift-home2.png" alt="Shoplift home page" class="w-full">
                        </div>
                        <div class="z-20 w-2/3">
                ...
                <div class="my-24">
                    <div class="my-5 text-lg font-bold">Learnings</div>
                    <p class="text-sm text-justify">
                        I found this project refreshing as it opened up my mind to different approaches to design process. The key learning for me was seeing the
                        transition of how design can be formed and shaped into information. Found out that proper research, design thinking, and design
                        methodology can help help modulate your workflow or thought process.
                    </p>
                    <div class="my-5 text-lg font-bold">Next Steps</div>
                    <p class="text-sm text-justify">
                        The next steps will be to design other pending screens which I also currently have to improve the user flow. I would also love to explore
                        some more User Epics for the application, for example, catalogue sections, sign up, on-boarding process, shopping  possibilities.
                    </p>
                </div>
            </section>
                ...
                <div class="flex items-center justify-center my-24 space-x-4 md:space-x-8 md:my-36">
                    ...
                    <div>
                        <svg width="27" height="26" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.5403 10.9282L11.4885 2.2798L13.8746 0L27 12.5405L13.8746 25.0811L11.4885 22.8013L20.5403 14.1528H0V10.9282H20.5403Z" fill="white"/>
                        </svg>
                    </div>
                    <div><img src="img/galaxy-S20 Ultra1.png" alt="Galaxy S20"></div>
                </div>
            </section>
        </main>
        <div class="">         
